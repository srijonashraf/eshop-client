...
import { clearSessions, getAccessToken } from '../../utility/SessionHelper.js';
                ...
                <div className="container">
                    <div className="row justify-content-around">
                        <div className="col-md-6">
                            <span>
                                <span className="f-12">
                                    <i className="bi bi-envelope"></i> Support@eShop.com
                                </span>
                                <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01724245754
                                </span>
                            </span>
                        </div>
                        <div className="col-md-6">
